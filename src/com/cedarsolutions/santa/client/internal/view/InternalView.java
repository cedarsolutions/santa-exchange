 ...
 * @author Kenneth J. Pronovici <pronovic@ieee.org>
 */
public class InternalView extends ModuleTemplateView implements IInternalView {
    ...
    /** UI binder interface. */
    protected interface ViewUiBinder extends UiBinder<Widget, InternalView> {
    }

    /** Id handler interface. */
    protected interface ViewIdHandler extends ElementIdHandler<InternalView> {
    }
    ...
    @UiField @WithElementId protected MenuItem adminLandingPageItem;
    ...
    private boolean enableAdminLandingPage;
    private FederatedUser currentUser;
    private ViewEventHandler adminLandingPageEventHandler;
    ...
    public InternalView() {
        ...
        this.adminLandingPageItem.setText(constants.header_adminLandingPage());
    ...
    @Override
    public void setEnableAdminLandingPage(boolean enableAdminLandingPage) {
        this.enableAdminLandingPage = enableAdminLandingPage;
        if (this.enableAdminLandingPage) {
            this.adminLandingPageItem.setEnabled(true);
            this.adminLandingPageItem.setVisible(true);
        } else {
            this.adminLandingPageItem.setEnabled(false);
            this.adminLandingPageItem.setVisible(false);
        }
    }

    /** Indicates the admin landing page feature is enabled. */
    @Override
    public boolean getEnableAdminLandingPage() {
        return this.enableAdminLandingPage;
    }

    /** Set the event handler for the admin landing page action. */
    @Override
    public void setAdminLandingPageEventHandler(ViewEventHandler adminLandingPageEventHandler) {
        this.adminLandingPageEventHandler = adminLandingPageEventHandler;
        this.adminLandingPageItem.setScheduledCommand(new UnifiedMenuHandler(adminLandingPageEventHandler));
    }

    /** Get the admin landing page event handler. */
    @Override
    public ViewEventHandler getAdminLandingPageEventHandler() {
        return this.adminLandingPageEventHandler;
    }
