 ...
 * @author Kenneth J. Pronovici <pronovic@ieee.org>
 */
public class ExternalEventFilter extends ModuleSessionEventFilter<ExternalEventBus> {
    ...
    @Override
    protected boolean filterEventOnceInitialized(String eventType, Object[] params, ExternalEventBus eventBus) {
