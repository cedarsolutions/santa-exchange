...
/**
 * Module for events that are external (public-facing).
 * @author Kenneth J. Pronovici <pronovic@ieee.org>
 */
@HistoryName(SantaExchangeEventTypes.EXTERNAL_MODULE)
public interface ExternalModule extends Mvp4gModule {
}
