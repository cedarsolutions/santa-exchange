...
/**
 * History converter for the external module.
 * @author Kenneth J. Pronovici <pronovic@ieee.org>
 */
@History(type = HistoryConverterType.NONE)
public class ExternalHistoryConverter implements HistoryConverter<ExternalEventBus> {
    ...
    @Override
    public void convertFromToken(String eventType, String param, ExternalEventBus eventBus) {
