...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
#
# Copyright (c) 2013,2015,2017 Kenneth J. Pronovici.
# All rights reserved.
#
...
Then /^the user should be taken to the external application dashboard page$/ do
    ...
    current_url_equals("https://accounts.google.com/ServiceLogin?service=ah&passive=true&continue=https%3A%2F%2Fappengine.google.com%2F_ah%2Fconflogin%3Fcontinue%3Dhttps%3A%2F%2Fappengine.google.com%2Fdashboard%253F%2526app_id%253Dsanta-exchange-hrd#identifier")
end
