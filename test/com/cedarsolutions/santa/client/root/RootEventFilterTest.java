...
/**
 * Unit tests for RootEventFilter.
 * @author Kenneth J. Pronovici <pronovic@ieee.org>
 */
public class RootEventFilterTest extends StubbedClientTestCase {

    /** Test getClientSession(). */
    @Test public void testGetClientSession() {
        RootEventFilter filter = createFilter();
    ...
    @Test public void getExcludedEventTypes() {
        ...
        assertTrue(excluded.contains(SantaExchangeEventTypes.INIT));
    ...
    private static RootEventFilter createFilter() {
        ...
        RootEventFilter filter = new RootEventFilter();
